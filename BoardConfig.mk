...
# Assert
TARGET_OTA_ASSERT_DEVICE := tecno-BF7
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x4000000
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4

BOARD_VENDORIMAGE_PARTITION_SIZE := 0x4000000
...
# Dynamic Partition
BOARD_SUPER_PARTITION_SIZE := 6544097280
BOARD_SUPER_PARTITION_GROUPS := tecno_dynamic_partitions
BOARD_TECNO_DYNAMIC_PARTITIONS_SIZE := 6544097280
...
PRODUCT_COPY_FILES += device/tecno/BF7/recovery/root/system/etc/recovery.fstab:recovery/root/system/etc/recovery.fstab
...
TW_USE_TOOLBOX := true
TW_DEVICE_VERSION := TECNO BF7_2301_v2262
TW_DEFAULT_DEVICE_NAME := TECNO-BF7
